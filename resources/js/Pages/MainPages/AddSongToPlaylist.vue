...
const submit = function () {
    form.post(`/playlists/add-song/${props.song_id}`, {
        onSuccess: () => {
            Swal.fire({
                title: 'Success!',
                text: 'Added song to playlists successfully!',
                icon: 'success',
        ...
        <form @submit.prevent="submit()" class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 mt-3">
            ...
            <div v-for="playlist in playlist">
                <div class="flex items-center mb-4">
                    <input id="default-checkbox" type="checkbox" :value="playlist.id" v-model="form.playlist_id"
